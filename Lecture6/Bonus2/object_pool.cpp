...
class ObjectPool{
    ...
    public:
        ...
        Resource* getResource(){
            if (resources.empty()){
                std::cout << "No slots available, try again later" << std::endl;
                return nullptr;
            }
            else{
                std::cout << "Giving you available slot" << std::endl;
...
int main()
{
    ...
    four = pool->getResource();
    five = pool->getResource();
    six = pool->getResource();
    if(six != nullptr)
      std::cout << "six = " << six->getValue() << " [" << six << "]" << std::endl;
    else
      std::cout << "could not create six" << std::endl;
